export const en = {
  ...
  contact: {
    ...
    email: {
      ...
      addresses: [
        { email: "stefan@axiestudio.se", label: "General inquiries" },
        { email: "support@axiestudio.se", label: "Support & help" }
      ]
    },
    ...
    phone: {
      ...
      numbers: [
        { number: "+46 735 132 620", label: "Sweden" },
        { number: "+63 962 576 1387", label: "Philippines" }
      ]
    },
  ...
  privacy: {
    ...
    contact: {
      title: "Contact Us",
      content: [
        "If you have questions about this privacy policy or how we handle your personal information, contact us at stefan@axiestudio.se.",
